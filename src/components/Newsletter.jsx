...
const Newsletter = () => {
  ...
  return (
    <section className="bg-maroon py-8 sm:py-12 md:py-16">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 sm:gap-4 max-w-xl mx-auto px-4">
            ...
            <button
              ...
              className="bg-gold hover:bg-amber-500 text-charcoal font-bold py-3 sm:py-4 px-6 sm:px-8 rounded-full transition-all transform disabled:opacity-50 disabled:cursor-not-allowed shadow-xl hover:shadow-2xl flex items-center justify-center space-x-2 text-sm sm:text-base whitespace-nowrap"
            >
