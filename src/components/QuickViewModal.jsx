...
import { X, Eye, ArrowRight, ShoppingCart, Star, Check } from 'lucide-react';
            ...
            <div className="flex-1">
              ...
              <div className="mb-6">
                {product.stock > 0 ? (
                    ...
                    <Check className="inline h-4 w-4 text-green-600 mr-1" /> In Stock ({product.stock} available)
                  </span>
                ) : (
                    <span className="inline-flex items-center text-red-600 font-semibold">
                    <X className="inline h-4 w-4 text-red-600 mr-1" /> Out of Stock
                  </span>
                )}
              </div>
